...
enum ResolutionPreset { low, medium, high, fhd, fhdx4 }
...
class CameraValue {
  ...
  /// True when the device has got a Torch/Flashlight
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> hasFlashlight() async {
    final bool _hasFlashlight = await _channel.invokeMethod('hasFlashlight');
    value = value.copyWith(hasFlashlight: _hasFlashlight);
  }
